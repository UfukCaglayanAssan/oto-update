...
int FMC_Proc(unsigned int u32Cmd, unsigned int addr_start, unsigned int addr_end, unsigned int *data)
{
    ...
    for (u32Addr = addr_start; u32Addr < addr_end; data++) {
        ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCMD = u32Cmd;
        ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPADDR = u32Addr;

        if (u32Cmd == 0x21UL) {
            ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPDAT = *data;
        }

        ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPTRG = 0x1;
        __builtin_arm_isb(0xF);;


        u32TimeOutCnt = (SystemCoreClock>>3);
        while (((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPTRG) {
            if(--u32TimeOutCnt == 0)
                return -1;
        }

        Reg = ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCTL;

        if (Reg & (0x1ul << (6))) {
            ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCTL = Reg;
            return -1;
        }

        if (u32Cmd == 0x00UL) {
            *data = ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPDAT;
        }
...
int EraseAP(unsigned int addr_start, unsigned int size)
{
    ...
    while (size > 0) {
        ...
        } else if ((size >= (0x800UL * 4UL)) && !(u32Addr & ((0x800UL * 4UL) - 1))) {
            u32Cmd = 0x25UL;
            u32Size = (0x800UL * 4UL);
        } else {
            u32Cmd = 0x22UL;
        ...
        if (((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCTL & (0x1ul << (6))) {
            ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCTL |= (0x1ul << (6));
            return -1;
        }
...
void UpdateConfig(unsigned int *data, unsigned int *res)
{
    (((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCTL |= (0x1ul << (4)));
    FMC_Proc(0x22UL, 0x00300000UL, 0x00300000UL + 16, 0);
    FMC_Proc(0x21UL, 0x00300000UL, 0x00300000UL + 16, data);

    if (res) {
        FMC_Proc(0x00UL, 0x00300000UL, 0x00300000UL + 16, res);
    }
