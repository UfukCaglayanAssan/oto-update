...
# 51 "C:\\Users\\odmeric\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\string.h" 3
...
# 18 "../../../../Library/StdDriver/inc\\sdh.h"
...
# 19 "../../../../Library/StdDriver/inc\\sdh.h" 2
...
void PutString(void);
# 15 "../uart_transfer.c" 2

__attribute__((aligned(4))) uint8_t g_au8uart_rcvbuf[64] = {0};
...
void UART0_IRQHandler(void)
{
    ...
    uint32_t u32IntSrc = ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->INTSTS;


    if (u32IntSrc & ((0x1ul << (4))|(0x1ul << (0))) )
    {

        while (((((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (14))) == 0) && (g_u8bufhead < 64))
        {
            g_au8uart_rcvbuf[g_u8bufhead++] = ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->DAT;
        }
    }
    ...
    if (g_u8bufhead == 64)
    {
        g_u8bUartDataReady = (1L);
        g_u8bufhead = 0;
    }
    else if (u32IntSrc & (0x1ul << (4)))
    {
        g_u8bufhead = 0;
    }
}
...
void PutString(void)
{
    ...
    for (i = 0; i < 64; i++)
    {
        ...
        ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->DAT = g_au8ResponseBuff[i];
    }
}
...
void UART_Init()
{
    ...
    ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FUNCSEL = (0x0UL << (0));

    ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->LINE = (3UL) | (0x0UL << (3)) | (0x0UL << (2));

    ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFO = (0x3UL << (4)) | (0x3UL << (16));

    ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->BAUD = (((0x1ul << (29)) | (0x1ul << (28))) | (((((12000000UL)) + ((115200)/2ul)) / (115200))-2ul));

    ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->TOUT = (((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->TOUT & ~(0xfful << (0))) | (0x40);

    __NVIC_SetPriority(UART0_IRQn, 2);
    __NVIC_EnableIRQ(UART0_IRQn);

    ((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->INTEN = ((0x1ul << (11)) | (0x1ul << (4)) | (0x1ul << (0)));
}
