...
# 11 "../../../../Library/StdDriver/src/clk.c"
# 1 "../../../../Library/Device/Nuvoton/M261/Include\\NuMicro.h" 1
# 13 "../../../../Library/Device/Nuvoton/M261/Include\\NuMicro.h"
...
# 14 "../../../../Library/Device/Nuvoton/M261/Include\\NuMicro.h" 2
# 12 "../../../../Library/StdDriver/src/clk.c" 2
# 31 "../../../../Library/StdDriver/src/clk.c"
void CLK_DisableCKO(void)
{
...
# 97 "../../../../Library/StdDriver/src/clk.c"
void CLK_Idle(void)
{
...
# 116 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetHXTFreq(void)
{
...
# 140 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetLXTFreq(void)
{
    uint32_t u32Freq = 0UL;
...
# 164 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetHCLKFreq(void)
{
    SystemCoreClockUpdate();
    return SystemCoreClock;
}
# 177 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetPCLK0Freq(void)
{
    SystemCoreClockUpdate();
    return (SystemCoreClock >> ((((CLK_T *) ((0x40000000UL) + 0x00200UL))->PCLKDIV & (0x7ul << (0))) >> (0)));
}
# 190 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetPCLK1Freq(void)
{
    SystemCoreClockUpdate();
    return (SystemCoreClock >> ((((CLK_T *) ((0x40000000UL) + 0x00200UL))->PCLKDIV & (0x7ul << (4))) >> (4)));
}
# 203 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetCPUFreq(void)
{
    uint32_t u32Freq, u32HclkSrc, u32HclkDiv;
    uint32_t au32ClkTbl[] = {(12000000UL), (32768UL), 0UL, (10000UL), 0UL, (48000000UL), 0UL, (12000000UL)};
    ...
    if(u32HclkSrc == (0x01UL<<(0)))
    {
        ...
        if(((RTC_T *) (((0x40000000UL) + 0x00040000UL) + 0x01000UL))->LXTCTL & (0x1ul << (7)))
        {
            u32Freq = (32000UL);
        }
        else
...
# 304 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    u32PLSTATUS = ((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS & (0x3ul << (8));


    if((u32PLSTATUS == (0x0UL<<(8))) && (u32Hclk > 64000000UL))
    {
        u32Hclk = 64000000UL;
    }
    else if((u32PLSTATUS == (0x1UL<<(8))) && (u32Hclk > 48000000UL))
    {
        u32Hclk = 48000000UL;
    }
    ...
    ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->CYCCTL &= (~(0x1ul << (8)));
...
# 383 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    uint32_t u32HIRCSTB;
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->PWRCTL |= (0x1ul << (2));
    CLK_WaitClockReady((0x1ul << (4)));
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL0 = (((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL0 & (~(0x7ul << (0)))) | (0x07UL<<(0));
    ...
    {
        ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->CYCCTL = (((FMC_T *) ((0x40000000UL) + 0x0C000UL))->CYCCTL & (~(0xful << (0)))) | (0x1ul << (8)) | (3UL);
    }
...
# 536 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
...
# 739 "../../../../Library/StdDriver/src/clk.c"
void CLK_DisableModuleClock(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
...
# 761 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if((u32PllFreq <= 144000000UL) && (u32PllFreq >= 24000000UL))
    {
    ...
    else
    {
        ...
        if((((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLSTS & (0x3ul << (8))) == (0x0UL<<(0)))
        {


            ((CLK_T *) ((0x40000000UL) + 0x00200UL))->PLLCTL = u32PllClkSrc | (0x00000000UL | (((3UL)-1UL)<<9) | ((16UL)-2UL) | 0x4000UL);


            u32PllClk = 64000000UL;
...
# 902 "../../../../Library/StdDriver/src/clk.c"
void CLK_DisablePLL(void)
{
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->PLLCTL |= (0x1ul << (16));
}
# 922 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
    uint32_t u32TimeOutCnt = SystemCoreClock>>3;
    uint32_t u32Ret = 1U;
...
# 952 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableSysTick(uint32_t u32ClkSrc, uint32_t u32Count)
{
...
uint32_t CLK_GetModuleClockSource(uint32_t u32ModuleIdx)
{
    ...
    if(u32ModuleIdx == ((((2UL) & 0x03UL) << 30)|((((uint32_t)(16)) & 0x1fUL) << 0)| (((0x0UL) & 0x03UL) << 28)|(((0x0UL) & 0x07UL) << 25)|(((0x0UL) & 0x1fUL) << 20)| (((0x0UL) & 0x03UL) << 18)|(((0x0UL) & 0xffUL) << 10)|(((0x0UL) & 0x1fUL) << 5)))
    {
...
# 1214 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockDivider(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
    uint32_t au32DivTbl[4] = {0x0UL, 0x4UL, 0x8UL, 0x10UL};
