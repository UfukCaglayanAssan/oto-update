...
int32_t SYS_Init(void)
{
    ...
    while (!(((CLK_T *) ((0x40000000UL) + 0x00200UL))->STATUS & (0x1ul << (4))))
    ...
    u32TimeOutCnt = SystemCoreClock;
    while (!(((CLK_T *) ((0x40000000UL) + 0x00200UL))->STATUS & (0x1ul << (2))))
        if(--u32TimeOutCnt == 0) return -1;


    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKDIV0 = (((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKDIV0 & (~(0xful << (0)))) | (((2)-1UL) << (0));
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL0 = (((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL0 & (~(0x7ul << (0)))) | (0x02UL<<(0));
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL1 = (((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL1 & (~(0x3ul << (24)))) | (0x3UL<<(24));
...
int32_t main(void)
{
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->AHBCLK |= (0x1ul << (2));
    ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCTL |= (0x1ul << (0));


    g_u32ApromSize = BL_EnableFMC();
    g_u32DataFlashAddr = ((SCU_T *) ((0x40000000UL) + 0x2F000UL))->FNSADDR;
    ...
    while (1)
    {
        ...
        if ((g_u8bufhead >= 4) || (g_u8bUartDataReady == (1L)))
        {
            uint32_t u32lcmd;
            u32lcmd = ((*((volatile unsigned int *)(g_au8uart_rcvbuf))));

            if (u32lcmd == 0x000000AE)
            {
                goto _ISP;
            }
            else
            {
                g_u8bUartDataReady = (0L);
                g_u8bufhead = 0;
            }
        }
...
_ISP:
    ...
    while (1)
    {
        if (g_u8bUartDataReady == (1L))
        {
            g_u8bUartDataReady = (0L);
            ParseCmd(g_au8uart_rcvbuf, 64);
            PutString();
        }
    }
